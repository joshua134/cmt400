    ...
    if(isset($_POST['checkaccount'])){
        ...
        if(empty($email)){
            ...
            if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
                ...
                $query = "SELECT * FROM user WHERE email = '$email' AND is_lecturer = true LIMIT 1";
                ...
                if( mysqli_num_rows($result) < 1 ){
                    ...
                    session_start();
                    $_SESSION['lecturerPasswordResetEmail'] = $email;
                    $q = "UPDATE user SET password_reset_code = '$password_reset_code' WHERE email = '$email' AND is_lecturer = true ";
