<?php
    ...
    if(isset($_POST['create'])){
        ...
        if(empty($title) || empty($content)){
            ...
            $result = mysqli_query($connection, "SELECT title FROM board WHERE title = '$title' AND departmentID = $lecturerDepartmentID AND is_announcement = true");
            ...
            if( mysqli_num_rows($result) > 0 ){
                ...
                if(empty($_FILES['image']['name'])){
                    // no image
                    $sql1= "INSERT INTO board(title, content, is_announcement, is_lecturer, lecID, departmentID) VALUES ('$title','$content', true, true, $lectureID, $lecturerDepartmentID)";
                    ...
                    if(!in_array($image_ext, $allowed_extensions)){
                        ...
                        $sql2= "INSERT INTO board(title, content, media, is_announcement, is_lecturer, lecID, departmentID) VALUES ('$title','$content', '$file_name', true, true, $lectureID, $lecturerDepartmentID)";
...
<body>
    ...
    <div class="container">
        <div class="wrapper">
            ...
            <form method="post" enctype="multipart/form-data" onsubmit="return createAnnouncement()">
